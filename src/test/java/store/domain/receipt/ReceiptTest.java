...
class ReceiptTest {
    ...
    void makeReceipt() {
        ...
        Promotion promotion = new Promotion(
                PromotionType.BUY_N_GET_ONE_FREE, 2, 1, LocalDate.of(2024, 11, 9), LocalDate.of(2024, 11, 15));
        ...
        StoreInventory storeInventory = new StoreInventory(Arrays.asList(colaInventory, energyBarInventory));

        Order order = new Order(Map.of(cola,3, energyBar, 5));
        Receipt receipt = new Receipt(order, storeInventory);
